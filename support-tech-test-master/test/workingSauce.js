...
describe('Working Sauce', function () {
    utils.workingCapabilities['sauce:options'].tags = new Date()
    it('should go to Google and click Sauce', async function () {
        ...
        // Task I (select i am  a link )
        //await driver.findElement(By.id("i am a link")).click()

        // Task II (clear  and  insert  text)
        await driver.findElement(By.id("i_am_a_textbox")).clear();

        await driver.findElement(By.id("i_am_a_textbox")).sendKeys("Sauce");

        //Task III -  adds an email to the email field, 
        // adds text to the comments field, and clicks the "Send" button.

        await driver.findElement(By.id("fbemail")).sendKeys("olayonuoluwatimilehin@gmail.com");

        await driver.findElement(By.id("comments")).sendKeys("Hi i think it worked");
